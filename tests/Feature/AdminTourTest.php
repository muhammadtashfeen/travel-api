...
class AdminTourTest extends TestCase
{
    ...
    public function testPublicUserCannotAccessAddingTour(): void
    {
    ...
    public function testNonAdminUserCannotAccessAddingTour(): void
    {
    ...
    public function testSavesTourSuccessfullyWithValidData(): void
    {
        $this->seed(RoleSeeder::class);
        $user = User::factory()->create();
